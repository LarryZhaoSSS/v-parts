...
exports.default = _default;
        var $64fd7e = exports.default || module.exports;
      
      if (typeof $64fd7e === 'function') {
        $64fd7e = $64fd7e.options;
      }
    
        /* template */
        Object.assign($64fd7e, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$64fd7e', $64fd7e);
          } else {
            api.reload('$64fd7e', $64fd7e);
          }
        }
  ...
  mounted: function mounted() {
    ...
    try {
      for (var _iterator = this.$el.children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (name !== 'button') {
          consle.warn("g-button-group\u7684\u5B50\u5143\u7D20\u5E94\u8BE5\u5168\u662Fg-button,\u4F46\u4F60\u5199\u7684\u662F".concat(name));
        }
      }
    } catch (err) {
...
exports.default = _default;
        var $e7a02c = exports.default || module.exports;
      
      if (typeof $e7a02c === 'function') {
        $e7a02c = $e7a02c.options;
      }
    
        /* template */
        Object.assign($e7a02c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e7a02c', $e7a02c);
          } else {
            api.reload('$e7a02c', $e7a02c);
          }
        }
